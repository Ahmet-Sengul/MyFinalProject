...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        public IDataResult<List<ProductDetailDto>> GetProcutDetails()
        {
        ...
        private IResult CheckIfProductNameExists(string prductName)
        {
            var result = _productDal.GetAll(p => p.ProductName == prductName).Any();
            if (result)
            {
